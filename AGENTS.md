...
2. A requested change would require private keys, payment setup, live ads, tracking scripts, framework replacement, medical diagnosis claims, or deletion of major working code.
...
- improve pet category pages
- improve local ad planning pages
...
Stop only for blocked writes, major code deletion, framework changes, private keys, payment setup, live tracking, live ads, medical diagnosis claims, unclear repository state, or a change that could break production in a way that cannot be safely repaired in the same work session.

## Tech rule

Keep PetNeeds on simple website files unless the owner clearly requests a rebuild.
